...
public class GooglePlaces extends Activity implements OnItemClickListener, View.OnClickListener {
...
//	private static final String API_KEY = "AIzaSyAU9ShujnIg3IDQxtPr7Q1qOvFVdwNmWc4";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        autoCompView.setAdapter(new GooglePlacesAutocompleteAdapter(this, R.layout.element_google));
...
//        if (getIntent().getFlags() == 1)
            setResult(1, new Intent().putExtra("From", autoCompView.getText().toString()));
//        else if (getIntent().getFlags() == 2)
//            setResult(2, new Intent().putExtra("To", autoCompView.getText().toString()));
//        else if (getIntent().getFlags() == 3)
//            setResult(3, new Intent().putExtra("Via1", autoCompView.getText().toString()));
//        else if (getIntent().getFlags() == 4)
//            setResult(4, new Intent().putExtra("Via2", autoCompView.getText().toString()));
