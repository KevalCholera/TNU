package com.smartsense.taxinearyou.SnackBar;
...
public final class TSnackbar {
    ...
    private TSnackbar(ViewGroup parent) {
        ...
        mView = (SnackbarLayout) inflater.inflate(R.layout.element_snackbar_layout, mParent, false);
    }
    ...
    private void animateViewIn() {
        ...
        anim.setInterpolator(com.smartsense.taxinearyou.SnackBar.AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
